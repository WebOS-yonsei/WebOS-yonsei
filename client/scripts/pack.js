...
function api(opts = {}) {
  ...
  const config = configFactory(opts.production ? 'production' : 'development', opts['content-hash'], opts.isomorphic, !opts.animation, opts.framework, opts['ilib-additional-path']);
...
function cli(args) {
  const opts = minimist(args, {
    boolean: ['content-hash', 'custom-skin', 'minify', 'framework', 'externals-corejs', 'stats', 'production', 'isomorphic', 'snapshot', 'animation', 'verbose', 'watch', 'help'],
